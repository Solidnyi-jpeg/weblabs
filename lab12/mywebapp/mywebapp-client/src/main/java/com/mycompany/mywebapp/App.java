...
public class App implements EntryPoint {
	...
	public void onModuleLoad() {
		...
		dialogBox.addStyleName("bg-red-500 px-2 py-2 rounded-lg text-white");
		...
		TextBox nameField1 = new TextBox();
		nameField1.getElement().setPropertyString("placeholder", "Ваше ім'я");

		TextBox emailField = new TextBox();
		emailField.getElement().setPropertyString("placeholder", "Ваш email");
		...
		form.add(panel);
		form.addStyleName("mx-auto");
		panel.addStyleName("flex flex-col items-center");
		...
		RootPanel headerPanel = RootPanel.get("header");
			...
			Label headerTitle = new Label("My Web App");
			headerTitle.addStyleName("text-3xl font-bold text-center py-4");
		...
		weatherBtn.addStyleName("bg-blue-500 text-white px-4 py-2 rounded-lg");

		RootPanel.get("weatherButton").add(weatherBtn);

		weatherBtn.addClickHandler(event -> {

			Frame frame = new Frame("https://www.meteoblue.com/en/weather/widget/daily/rivne_ukraine_695594?geoloc=fixed");
			
			frame.setWidth("800px");
			frame.setHeight("610px");
		...
		class MyHandler implements ClickHandler, KeyUpHandler {
			...
			private void sendNameToServer() {
				...
				errorLabel.setText("");
				String textToServer = nameField1.getText();
